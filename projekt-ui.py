...
class Prozor(Frame):
    ...
    def kreirajSucelje(self):
        ...
        self.style.configure("TMenubutton", font = ('Arial', 18))
    ...
    def izracunaj(self):
        ...
        value, S, matched, distance, time, riderTime = genAlg(self.riders, self.drivers, self.distMat, self.timeMat, vals, self.koordinate)
        s = S[len(S) - 1]
